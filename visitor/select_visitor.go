...
func (this *SelectVisitor) leaveSelectStmt(node *ast.SelectStmt) error {
	// pop 出语句号, 并计算应该到第几个语句了
...
func (this *SelectVisitor) enterFieldList(node *ast.FieldList) error {
...
// 离开 TableSource
func (this *SelectVisitor) leaveTableSource(node *ast.TableSource) error {
	// 当前语句没有分表信息, 直接退出
	if this.CurrVisitorStmt == nil {
		return nil
	}
...
// 进入 IN 语句
func (this *SelectVisitor) enterPatternInExpr(node *ast.PatternInExpr) error {
...
// 进入 Like 语句
func (this *SelectVisitor) enterPatternLikeExpr(node *ast.PatternLikeExpr) error {
...
// 离开 Like 语句
func (this *SelectVisitor) leavePatternLikeExpr(node *ast.PatternLikeExpr) error {
	defer this.popBlock()
	if this.CurrVisitorStmt == nil { // 如果该语句中没有分库分表, 就不用管了
		return nil
	}
...
// 进入 BETWEEN 语句
func (this *SelectVisitor) enterBetweenExpr(node *ast.BetweenExpr) error {
