CREATE TABLE `servers` (
  ...
  `name` varchar(150) NOT NULL DEFAULT '' COMMENT 'dal服务名',
  ...
  `shard_table_instance_num` int(11) NOT NULL DEFAULT '8' COMMENT 'shard table资源实例个数,思想来源于mysql的多instance',
  `cluster_instance_num` int(11) NOT NULL DEFAULT '8' COMMENT 'cluster资源实例个数,思想来源于mysql的多instance',
  PRIMARY KEY (`id`),
  UNIQUE KEY `udx_name` (`name`),
  KEY `idx_username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='dal服务信息';

CREATE TABLE `groups` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `server_id` bigint(20) NOT NULL COMMENT '关联哪个dal服务',
  `db_name` varchar(150) NOT NULL DEFAULT '' COMMENT '使用的数据库名称',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='组';
...
CREATE TABLE `shard_tables` (
  ...
  KEY `idx_name` (`name`),
  KEY `idx_server_id` (`server_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='需要shard的表';

-- ------------------------- 分库分表 --------------------
-- clusters
INSERT INTO servers VALUES (1, 'cluster-name-01', '0.0.0.0', 13306, 'shop', 'chenhao', 'chenhao1', DEFAULT, DEFAULT, DEFAULT, DEFAULT);
-- group
...
(NULL, 1, 1, 1, 1, 'HH', 'oracle12', '127.0.0.1', 3306, 'shop_0', 1, 'utf8mb4', 1, DEFAULT, DEFAULT),
(NULL, 1, 2, 1, 1, 'HH', 'oracle12', '127.0.0.1', 3306, 'shop_1', 1, 'utf8mb4', 1, DEFAULT, DEFAULT),
(NULL, 1, 3, 1, 1, 'HH', 'oracle12', '127.0.0.1', 3306, 'shop_2', 1, 'utf8mb4', 1, DEFAULT, DEFAULT),
(NULL, 1, 4, 1, 1, 'HH', 'oracle12', '127.0.0.1', 3306, 'shop_3', 1, 'utf8mb4', 1, DEFAULT, DEFAULT);
-- shard tables
...
-- ------------------------- 非分库分表 --------------------
-- clusters
INSERT INTO clusters VALUES (2, 'cluster-name-02', '0.0.0.0', 23306, 'employees', 'root', 'root12', DEFAULT, DEFAULT, DEFAULT, DEFAULT);
-- group
INSERT INTO groups VALUES(5, 2, 'employees', 0, '', DEFAULT, DEFAULT);
-- nodes
INSERT INTO nodes VALUES(NULL, 2, 5, 1, 1, 'HH', 'oracle12', '127.0.0.1', 3306, 'employees', 1, 'utf8mb4', 1, DEFAULT, DEFAULT);
